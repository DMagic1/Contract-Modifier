...
{ 
    public abstract class DMCM_ConfigNodeStorage : IPersistenceLoad, IPersistenceSave
    {
        #region Constructors
        /// <summary>
        /// Class Constructor
        /// </summary>
        public DMCM_ConfigNodeStorage() { }
        /// <summary>
        /// Class Constructor
        /// </summary>
        ...
        public DMCM_ConfigNodeStorage(String FilePath) { this.FilePath = FilePath; }
        #endregion
